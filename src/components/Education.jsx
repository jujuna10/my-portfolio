    ...
    <div className='bg-gradient-to-r from-[#31242e]  via-[#31242e] to-[#33132b] w-[100%] p-[35px] py-[100px] h-[650px] relative rounded-[50px]'>
        ...
        <div className='absolute top-[5%]'>
            {numbers.map((item,index) => (
                <div>
                    <div key={index} className={`${index % 2 === 0 ? 'w-[5px] h-[145px] bg-[rgb(254,0,202)]' : 'w-[15px] h-[15px] rounded-[50%] bg-[rgb(254,0,202)] shadow-[0px_0px_25px_rgb(245,0,202)] translate-x-[-35%]' }`}></div>
                </div>
            ))}
        </div>
        ...
        <div className='flex flex-col justify-start gap-[20px]'>
            {years.map((item,index) => (
                <div className={`${index % 2 === 0 ? 'translate-x-[-70%]' : ''} ${index % 2 === 1 ? 'translate-x-[70%]' : ''} translate-y-[25%] flex flex-col gap-[10px]`}>
